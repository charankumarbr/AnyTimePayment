...
public class CameraSource {
        ...
        synchronized (mCameraLock) {
            ...
            if (mProcessingThread != null) {
                try {
                    ...
                    AppLog.debug(TAG, "Frame processing thread interrupted on release.");
                }
            ...
            if (mCamera != null) {
                ...
                try {
                    ...
                    AppLog.error(TAG, "Failed to clear camera preview: " + e);
                }
                mCamera.release();
                mCamera = null;
            }
    ...
    public int doZoom(float scale) {
        synchronized (mCameraLock) {
            ...
            if (!parameters.isZoomSupported()) {
                AppLog.warn(TAG, "Zoom is not supported on this device");
                return currentZoom;
            }
    ...
    private static List<SizePair> generateValidPreviewSizeList(Camera camera) {
        ...
        if (validPreviewSizes.size() == 0) {
            AppLog.warn(TAG, "No preview sizes have a corresponding same-aspect-ratio picture size");
            for (Camera.Size previewSize : supportedPreviewSizes) {
    ...
    private void setRotation(Camera camera, Camera.Parameters parameters, int cameraId) {
        ...
        switch (rotation) {
            ...
            case Surface.ROTATION_270:
                ...
                break;
            default:
                AppLog.error(TAG, "Bad rotation value: " + rotation);
        }
        ...
        public void run() {
            ...
            while (true) {
                synchronized (mLock) {
                    while (mActive && (mPendingFrameData == null)) {
                        try {
                            ...
                            AppLog.debug(TAG, "Frame processing loop terminated.", e);
                            return;
                        }
                    }
                ...
                try {
                    ...
                    AppLog.error(TAG, "Exception thrown from receiver.", t);
                } finally {
